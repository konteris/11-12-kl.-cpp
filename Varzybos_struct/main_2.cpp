...
void rasyti()
{
    ...
    cout<<"PAGRINDINIS SÀRAÐAS\n";
    for(int i=0; i<f ; i++)
        cout<<i+1<<". "<<Fpagrindinis[i].vardas<<" "<<Fpagrindinis[i].taskai<<" "<<Fpagrindinis[i].pavadinimas<<endl;
    cout<<"PAPILDOMAS SÀRAÐAS\n";
    for(int i=0; i<p ; i++)
        cout<<Fpapildomas[i].vardas<<" "<<Fpapildomas[i].taskai<<" "<<Fpapildomas[i].pavadinimas<<endl;
}
